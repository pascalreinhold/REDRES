...
class ResourceManager {
  public:
    ...
    [[nodiscard]] uint32_t createBuffer(size_t size,
    ...
    [[nodiscard]] BufferResource createBufferResource(uint32_t buffer_handle,
