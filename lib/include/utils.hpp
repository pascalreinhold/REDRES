...
struct GPUSceneData {
    ...
    glm::vec4 mouse_coords;
    PointLight point_lights[RCC_POINT_LIGHT_COUNT];
};
...
struct FrameData {
    ...
    BufferResource mouse_bucket_buffer{};

    vk::DescriptorSet global_descriptor_set, deferred_descriptor_set, compute_shader_set;
    vk::Semaphore present_semaphore, render_semaphore, offscreen_semaphore;
